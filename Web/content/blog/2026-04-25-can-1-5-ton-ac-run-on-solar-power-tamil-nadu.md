...
**Non-Inverter ACs:**
These traditional units have a simple ON/OFF compressor. When the room gets warm, the compressor kicks on at 100% capacity. When the target temperature is reached, it shuts off completely. 
...
**Inverter ACs:**
Modern inverter ACs feature a Variable Frequency Drive (VFD) that controls the speed of the compressor motor. Instead of turning on and off, the compressor runs continuously but adjusts its speed based on the cooling demand.
...
1.  **Morning to Afternoon (Daytime Running):** If you turn on your AC at 1:00 PM on a hot Saturday, the solar panels on your roof will intercept the sun's energy, convert it to AC power via the grid-tie inverter, and feed it directly into your AC. Your TNEB meter will effectively freeze at "zero."
2.  **Exporting Surplus:** Because a 3kW system generates around 3,000 Watts at noon, and your AC only consumes 1,000 Watts, the remaining 2,000 Watts of surplus power is forcefully pushed out of your house and into the TNEB grid. Your net meter records this as "Exported Units."
3.  **Nighttime Running:** The sun sets. You go to sleep and turn on your AC. Your house is now completely pulling power from the TNEB grid, just like it did before you had solar. 
4.  **The Net Metering Magic:** At the end of the two-month billing cycle, the TNEB assessor calculates your bill. They take the hundreds of units you imported at night and subtract the hundreds of units you exported during the day. If you sized your system correctly, the result is zero.
