...
1. Your solar panels generate power. The home uses what it needs (fridge, fans, TV).
2. The surplus power that you are not using at that moment is pushed out of your house and into the TNEB street grid. A bi-directional Net Meter on your wall counts every unit you export.

During the night:
1. Your solar panels are off. You pull power from the TNEB grid to run your ACs.
2. The Net Meter counts every unit you import.
