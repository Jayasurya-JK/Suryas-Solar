...
const WashIcon = () => (
  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" d="M4 4h16a1 1 0 011 1v14a1 1 0 01-1 1H4a1 1 0 01-1-1V5a1 1 0 011-1zm8 4a4 4 0 100 8 4 4 0 000-8z" />
  </svg>
)
...
const SYSTEM = {
  kw: '3kW',
  kwhPerDay: '12–15',
  recommended: '2BHK Home',
  subsidyAmount: '₹78,000',
  priceFrom: '₹1,80,000 – ₹2,00,000',
  priceAfterSubsidy: '~₹1,10,000',
  billRange: '₹1,500 – ₹3,500',
  appliances: [
    { name: '1.5 Ton AC', qty: '1 unit (6–8 hrs)', Icon: AcIcon },
    { name: 'Refrigerator 250L', qty: '1 unit (24 hrs)', Icon: FridgeIcon },
    { name: 'TV & Computer', qty: '6+ hrs daily', Icon: TvIcon },
    { name: 'Lights & Fans', qty: '5–10 units', Icon: LightIcon },
    { name: 'Washing Machine', qty: '1 cycle / day', Icon: WashIcon },
  ],
  whatsapp: "Hi, I want the exact quotation for a 3kW Solar System."
}

export default function ThreeKwPage({ settings }) {
  return (
    <>
      <Head>
          ...
          <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 pt-32 pb-20">
            <div className="max-w-2xl">
              <nav className="flex items-center gap-2 text-xs text-blue-200/70 font-medium mb-8">
                ...
                <span className="text-blue-300/40">›</span>
                <span className="text-white">3kW Solar System</span>
              </nav>
              ...
              <h1 className="font-playfair text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-[1.05] mb-6">
                3kW Solar System<br />
                <span className="text-blue-300">With Subsidy</span><br />
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a href="#booking" className="inline-flex items-center justify-center gap-2.5 px-8 py-4 rounded-xl bg-orange-500 hover:bg-orange-600 text-white font-bold text-base shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all">
                  Get Free Quote Now
                </a>
        ...
        <section className="relative z-10 -mt-2">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-white rounded-3xl shadow-2xl border border-gray-100 grid grid-cols-2 md:grid-cols-4 divide-x divide-y md:divide-y-0 divide-gray-100 overflow-hidden">
              {[
                { val: <CountUp end={15} prefix="12–" duration={2.5} enableScrollSpy scrollSpyOnce />, sub: 'Units Generated / Day', Icon: BoltIcon, color: 'text-blue-600' },
                ...
                { val: <CountUp end={78000} prefix="₹" separator="," duration={2.5} enableScrollSpy scrollSpyOnce />, sub: 'Max Govt Subsidy', Icon: RupeeIcon, color: 'text-indigo-600' },
                { val: <CountUp end={3} prefix="< " suffix=" Years" duration={2.5} enableScrollSpy scrollSpyOnce />, sub: 'Return on Investment', Icon: TrendIcon, color: 'text-orange-500' },
              ].map(s => (
        ...
        <section className="py-20 md:py-28">
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
            <div className="text-center mb-14">
              ...
              <h2 className="mt-3 text-4xl md:text-5xl font-playfair font-bold text-gray-900">What Runs on a 3kW System?</h2>
              ...
              <div className="rounded-3xl overflow-hidden" style={{ background: 'linear-gradient(135deg, #0f2e6e 0%, #1542a7 100%)' }}>
                <div className="p-8 relative">
                  ...
                  <div className="relative z-10">
                    ...
                    <h3 className="text-white text-2xl font-bold mb-8">3kW System Cost Breakdown</h3>
                    ...
                    <p className="text-white/40 text-xs mb-6">*A 3kW system qualifies for the MAXIMUM subsidy slab. 4kW or 5kW does NOT increase your subsidy.</p>
            ...
            <div className="space-y-3">
              {[
                ...
                },
                {
                  ...
                  a: 'After signing the contract and subsidy documentation, our team completes physical installation in 1–2 days. The TNEB net meter upgrade takes 30–45 additional days, after which the system is fully operational and earning export credits.'
                },
              ].map((faq, i) => (
