    ...
    <>
      ...
      <main className="bg-white">
        ...
        <section className="relative min-h-[82vh] flex items-center overflow-hidden" style={{ background: 'linear-gradient(135deg, #0f2e6e 0%, #1542a7 50%, #1e62d4 100%)' }}>
          {/* Glow orb */}
          <div className="absolute top-0 right-1/4 w-[500px] h-[500px] rounded-full blur-3xl pointer-events-none" style={{ background: 'radial-gradient(circle, rgba(255,165,0,0.12) 0%, transparent 70%)' }} />
